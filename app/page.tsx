...
export default function Page() {
  return (
    <main className="flex min-h-screen flex-col p-6">
      ...
      <div className="flex h-16 shrink-0 items-end rounded-lg bg-blue-500 p-4 md:h-32">
        <AcmeLogo />
      </div>
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        ...
        <div className="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-8">
          ...
          <Image
            ...
            alt='Dashboard project screenshot desktop view'
            width={600}
            height={200}
          ...
          <Image
            src={'/hero-mobile.png'}
            alt='Dashboard project screenshot mobile view'
            width={560}
            height={620}
